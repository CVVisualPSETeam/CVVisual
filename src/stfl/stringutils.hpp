...
/**
 * @brief Replace the search string with its replacement at the very beginning of the given string.
 * @param str given string
 */
 ...
 * Replace the key of the replacements map with its map value in the given string
 * @param str given string
 * @param replacements replacements map
 */
void replaceIfStartsWith(QString &str, const std::map<QString, QString> &replacements);

/**
 * @brief Replace the search string with its replacement at the end of the given string.
 * @param str given string
 */
 ...
 * @param replacements replacements map
 */
void replaceIfEndsWith(QString &str, const std::map<QString, QString> &replacements);
