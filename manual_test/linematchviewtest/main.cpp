...
/**
 * @brief this test shows a linematchview, it should only end if u close the window manual.
 * The matches should be schow as line between the keypoints in the images.
 *
